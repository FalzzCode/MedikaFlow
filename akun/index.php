...
<section class="panel">
    ...
    <?php else: ?>
        ...
        <?php foreach ($accounts as $account): ?>
            <tr>
                <td><div class="patient-cell"><span class="patient-initial"><?= e(initials($account['nama_lengkap'])) ?></span><div><div class="cell-primary"><?= e($account['nama_lengkap']) ?></div><div class="cell-muted"><?= e($account['username']) ?> · <?= e($account['email']) ?></div></div></div></td>
